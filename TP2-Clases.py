...
class Datos:
    def __init__(self):
        ...
        self.K1 = 10   # costo por km en hoverboard
        self.K2 = 5    # costo por tramo de tranvía
        ...
        ubicaciones_g1 = [
            "Hospital", "Bomberos", "Comisaria", "Escuela",
            "Universidad", "Gasolineria", "Restaurante", "Cine"
        ]
        aristas_tranvia_g1 = [
            ("A", "B", 1), ("B", "C", 1), ("C", "D", 1),
            ("D", "E", 1), ("E", "F", 1), ("D", "G", 1), ("G", "H", 1)
        ]
        aristas_hoverboard_g1 = [
            ("Hospital", "A", 0.8), ("Bomberos", "B", 0.7),
            ("Comisaria", "D", 0.9), ("Escuela", "F", 0.6),
            ("Universidad", "H", 0.7), ("Gasolineria", "G", 0.5),
            ("Restaurante", "C", 0.8), ("Cine", "E", 0.9)
        ]
        ...
        ubicaciones_g2 = [
            "Hospital", "Bomberos", "Comisaria", "Escuela",
            "Universidad", "Gasolineria", "Restaurante",
            "DepartamentoA", "DepartamentoB", "Cine", "Biblioteca"
        ]
        aristas_tranvia_g2 = [
            ("A", "B", 1), ("B", "C", 1), ("C", "D", 1), ("D", "E", 1),
            ("E", "F", 1), ("F", "G", 1), ("G", "H", 1), ("C", "I", 1),
            ("I", "J", 1), ("J", "K", 1), ("E", "H", 1)
        ]
        aristas_hoverboard_g2 = [
            ("Hospital", "A", 0.4), ("Bomberos", "B", 0.3),
            ("Comisaria", "D", 0.4), ("Escuela", "E", 0.2),
            ("Universidad", "F", 0.3), ("Gasolineria", "G", 0.1),
            ("Restaurante", "H", 0.1), ("DepartamentoA", "K", 0.4),
            ("DepartamentoB", "J", 0.3), ("Cine", "I", 0.3),
            ("Biblioteca", "C", 0.3)
        ]
        ...
        ubicaciones_g3 = [
            "Hospital", "Bomberos", "Comisaria", "Escuela",
            "Universidad", "Gasolineria", "Cine"
        ]
        aristas_tranvia_g3 = [
            # anillo exterior
            ("B", "C", 1), ("C", "D", 1), ("D", "E", 1), ("E", "F", 1),
            ("F", "G", 1), ("G", "H", 1), ("H", "B", 1),
        ...
        aristas_hoverboard_g3 = [
            ("Hospital", "B", 0.5), ("Bomberos", "C", 0.5),
            ("Comisaria", "D", 0.5), ("Escuela", "E", 0.5),
            ("Universidad", "F", 0.5), ("Gasolineria", "G", 0.5),
            ("Cine", "H", 0.5)
        ]
        ...
        self.estaciones = estaciones_g2
        self.ubicaciones = ubicaciones_g2
        self.aristas_tranvia = aristas_tranvia_g2
        self.aristas_hoverboard = aristas_hoverboard_g2
    ...
    def construir(self):
        ...
        self.G.add_nodes_from(self.estaciones)

        # Agregamos los nodos correspondientes a las
        # ubicaciones secundarias (hospital, cine, etc.).
        self.G.add_nodes_from(self.ubicaciones)
        ...
        for origen, destino, tramos in self.aristas_tranvia:
            self.G.add_edge(
                origen,
                destino,
                tipo="tranvia",
        ...
        for origen, destino, km in self.aristas_hoverboard:
            self.G.add_edge(
                origen,
                destino,
                tipo="hoverboard",
        ...
        self.G_costos = nx.Graph()

        for u, v, datos in self.G.edges(data=True):
            if datos["tipo"] == "hoverboard":
                costo = self.K1 * datos["km"]
            else:
                costo = self.K2 * datos["tramos"]

            self.G_costos.add_edge(
                u,
                v,
                weight=costo
            )
...
class Dijkstra:
    def __init__(self, G_costos):
        self.G_costos = G_costos
    ...
    def resolver_ruta(self, origen, destino):
        """
...
class Kruskal:
    def __init__(self, aristas_tranvia):
        self.aristas_tranvia = aristas_tranvia
...
class Visualizacion:
    def __init__(self, G, estaciones, G_dijkstra, costo_minimo, G_camioneta):
        self.G = G
        self.estaciones = estaciones
        self.G_dijkstra = G_dijkstra
        self.costo_minimo = costo_minimo
        self.G_camioneta = G_camioneta
    ...
    # 3) Árbol de recubridor mínimo obtenido mediante Kruskal.
    #
    ...
    def mostrar(self):
        ...
        # Habilitar el siguiente código en caso de utilizar el tercer lote de datos y a su vez comentar la línea de arriba (pos = nx.spring_layout...)
        """pos = {
            "A": (0, 0),
            "B": (0, 4),
            "C": (-3.1, 2.5),
...
# ==========================================================
# BLOQUE MAIN (EJECUCIÓN PRINCIPAL)
# ==========================================================
if __name__ == "__main__":
    
    # 1. Cargamos los datos y construimos las bases
    datos = Datos()
    datos.construir()

    # 2. Resolvemos Dijkstra
    dijkstra = Dijkstra(datos.G_costos)
    ruta_minima, costo_minimo, G_dijkstra = dijkstra.resolver_ruta(
        "Hospital",
        "Cine"
    )

    # 3. Resolvemos Kruskal
    kruskal = Kruskal(datos.aristas_tranvia)
    G_camioneta = kruskal.resolver()

    # 4. Enviamos toda la información calculada a la visualización
    visualizador = Visualizacion(
        datos.G, 
        datos.estaciones, 
        G_dijkstra, 
        costo_minimo, 
